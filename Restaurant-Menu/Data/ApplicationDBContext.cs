    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      .HasColumnType("timestamptz");
        ...
        modelBuilder.Entity<WaiterRequest>(entity =>
        {
            ...
            entity.Property(e => e.Message).HasColumnName("message").IsRequired().HasMaxLength(250);
            entity.Property(e => e.TableNumber).HasColumnName("tablenumber");
            entity.Property(e => e.RequestTime).HasColumnName("requesttime").HasColumnType("timestamptz").HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.Property(e => e.IsNotified).HasColumnName("isnotified").HasDefaultValue(false);
        });
